...
class EnoSection {
  ...
  dictionary(name, ...optional) {
    let options = {
      enforceElement: true,
      required: true  // TODO: Implement as an alias for enforceElement
    };
  ...
  // TODO: required alias for enforceElement
  ...
  section(name, ...optional) {
    let options = {
      enforceElement: true,
      required: true  // TODO: Change logic so this works as an alias for enforceElement here (elsewhere for both enforceElement and enforceValue)
    };
