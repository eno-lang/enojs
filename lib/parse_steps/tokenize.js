...
module.exports = context => {
  ...
  while(true) {
    ...
    if(match[matcher.EMPTY_LINE_INDEX] !== undefined) {
      ...
      const operatorIndex = context.input.indexOf('>', index) - index;  // TODO: Look at why this is labeled index when it's already a column, check if consequences here and elsewhere
