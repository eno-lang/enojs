// This code was auto-generated on Wed Jul 04 2018 15:30:25 GMT+0200 (Central European Summer Time)
...
module.exports = {
  ...
  en: {
    ...
    loaders: {
      ...
      invalidDatetime: (name) => `'${name}' must contain valid date or date and time, for instance '1997-07-16' or '1994-11-05T13:15Z' (see https://www.w3.org/TR/NOTE-datetime).`,
      ...
      invalidUrl: (name) => `'${name}' must contain valid URL, for instance 'https://eno-lang.org'.`
    }
  },
  es: {
    elements: {
    ...
    loaders: {
      ...
      invalidCoordinates: (name) => `'${name}' debe contener un valida pareja de coordenadas latitud/longitud, por ejemplo '48.2093723, 16.356099'.`,
